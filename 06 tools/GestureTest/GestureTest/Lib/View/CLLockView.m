...
#pragma mark - 九个解锁视图 及其viewFrame
...
-(void)drawRect:(CGRect)rect{
    ...
    //设置线宽
    CGContextSetLineWidth(ctx, CoreLockLineWidth);
...
-(void)setpwdCheck{
    ...
    if(count < CoreLockMinItemCount){   //密码小于4位
...
-(void)lockHandle:(NSSet *)touches{
    ...
    //TODO: 实时监听密码
    if(_setPWMonitoBlock != nil) {
        _setPWMonitoBlock(self.pwdM);
    }
