...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var window: UIWindow?
    let majqAppkeyStr: String = "xxxxx"

    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        // Override point for customization after application launch.
        
        setUpJPushInitConfig(application, didFinishLaunchingWithOptions: launchOptions) //极光推送

        return true
    }
    
    ///极光推送部署
    fileprivate func setUpJPushInitConfig(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) {
        setUpJPUSHServiceFunction()
        setUpInitJPush(application, didFinishLaunchingWithOptions: launchOptions)
    }
...
extension AppDelegate: JPUSHRegisterDelegate {
    ...
    fileprivate func setUpInitJPush(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) {
        ...
        //init Push
        JPUSHService.setup(withOption: launchOptions, appKey: majqAppkeyStr, channel: "apps", apsForProduction: isProduction, advertisingIdentifier: advertisingId)
